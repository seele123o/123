...
class ProfileEntry extends DataClass implements Insertable<ProfileEntry> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      final converter = $ProfileEntriesTable.$convertertype;
    ...
    if (!nullToAbsent || updateInterval != null) {
      final converter = $ProfileEntriesTable.$converterupdateIntervaln;
      map['update_interval'] = Variable<int>(converter.toSql(updateInterval));
    }
  ...
  ProfileEntryCompanion toCompanion(bool nullToAbsent) {
    return ProfileEntryCompanion(
      id: Value(id),
      type: Value(type),
      active: Value(active),
      name: Value(name),
  ...
  factory ProfileEntry.fromJsonString(String encodedJson,
          {ValueSerializer? serializer}) =>
      ProfileEntry.fromJson(
...
class ProfileEntryCompanion extends UpdateCompanion<ProfileEntry> {
  ...
  ProfileEntryCompanion copyWith(
      {Value<String>? id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (updateInterval.present) {
      ...
      map['update_interval'] =
          Variable<int>(converter.toSql(updateInterval.value));
    }
    if (upload.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('ProfileEntryCompanion(')
          ..write('id: $id, ')
          ..write('type: $type, ')
          ..write('active: $active, ')
          ..write('name: $name, ')
...
class GeoAssetEntry extends DataClass implements Insertable<GeoAssetEntry> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<String>(id);
    {
      final converter = $GeoAssetEntriesTable.$convertertype;
      map['type'] = Variable<String>(converter.toSql(type));
    }
    map['active'] = Variable<bool>(active);
    map['name'] = Variable<String>(name);
  ...
  GeoAssetEntryCompanion toCompanion(bool nullToAbsent) {
    return GeoAssetEntryCompanion(
      id: Value(id),
      type: Value(type),
      active: Value(active),
      name: Value(name),
  ...
  factory GeoAssetEntry.fromJsonString(String encodedJson,
          {ValueSerializer? serializer}) =>
      GeoAssetEntry.fromJson(
          DataClass.parseJson(encodedJson) as Map<String, dynamic>,
          serializer: serializer);
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
...
class GeoAssetEntryCompanion extends UpdateCompanion<GeoAssetEntry> {
  final Value<String> id;
  ...
  GeoAssetEntryCompanion copyWith(
      {Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('GeoAssetEntryCompanion(')
          ..write('id: $id, ')
          ..write('type: $type, ')
          ..write('active: $active, ')
          ..write('name: $name, ')
