...
mixin _$ProfileDetailsState {
  ...
  bool get configContentChanged => throw _privateConstructorUsedError;
...
class _$ProfileDetailsStateCopyWithImpl<$Res, $Val extends ProfileDetailsState>
  ...
  $Res call({
    ...
    Object? configContentChanged = null,
  }) {
    return _then(_value.copyWith(
      ...
      configContent: null == configContent
          ...
          : configContent // ignore: cast_nullable_to_non_nullable
              as String,
      configContentChanged: null == configContentChanged
          ? _value.configContentChanged
          : configContentChanged // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
...
class _$ProfileDetailsStateImpl extends _ProfileDetailsState {
  const _$ProfileDetailsStateImpl(
      ...
      this.delete,
      this.configContent = "",
      this.configContentChanged = false})
      : super._();
  ...
  @override
  @JsonKey()
  final bool configContentChanged;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.configContentChanged, configContentChanged) ||
                other.configContentChanged == configContentChanged));
  }
...
abstract class _ProfileDetailsState extends ProfileDetailsState {
  const factory _ProfileDetailsState(
      ...
      final AsyncValue<void>? delete,
      final String configContent,
      final bool configContentChanged}) = _$ProfileDetailsStateImpl;
